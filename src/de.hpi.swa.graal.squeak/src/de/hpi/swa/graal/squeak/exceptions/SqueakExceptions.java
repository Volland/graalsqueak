...
public final class SqueakExceptions {
    ...
    public static final class SqueakSyntaxError extends RuntimeException implements TruffleException {
        ...
        protected class FakeSourceCodeObjectNode extends AbstractNode {
            ...
            public SourceSection getSourceSection() {
                if (sourceSection == null) {
                    ...
                    sourceSection = getImageUncached().getLastParseRequestSource().createSection(Math.max(sourceOffset - 1, 0), 1);
                }
